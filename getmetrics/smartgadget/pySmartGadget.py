...
class SHT31():
    ...
    def __prepareGadget(self):
        ...
        # READ WRITE
        self.__characteristics['DeviceName'] = \
        self.__peripheral.getCharacteristics(uuid=UUID("00002a00-0000-1000-8000-00805f9b34fb"))[0]
        # READ NOTIFY 
        self.__characteristics['Battery'] = self.__peripheral.getCharacteristics(uuid=UUID(0x2A19))[0]
        # WRITE
        self.__characteristics['SyncTimeMs'] = \
        self.__peripheral.getCharacteristics(uuid=UUID("0000f235-b38d-4985-720e-0f993a68ee41"))[0]
        # READ WRITE
        self.__characteristics['OldestTimeStampMs'] = \
        self.__peripheral.getCharacteristics(uuid=UUID("0000f236-b38d-4985-720e-0f993a68ee41"))[0]
        # READ WRITE 
        self.__characteristics['NewestTimeStampMs'] = \
        self.__peripheral.getCharacteristics(uuid=UUID("0000f237-b38d-4985-720e-0f993a68ee41"))[0]
        # WRITE NOTIFY 
        self.__characteristics['StartLoggerDownload'] = \
        self.__peripheral.getCharacteristics(uuid=UUID("0000f238-b38d-4985-720e-0f993a68ee41"))[0]
        # READ WRITE
        self.__characteristics['LoggerIntervalMs'] = \
        self.__peripheral.getCharacteristics(uuid=UUID("0000f239-b38d-4985-720e-0f993a68ee41"))[0]
        # READ NOTIFY 
        self.__characteristics['Humidity'] = \
        self.__peripheral.getCharacteristics(uuid=UUID("00001235-b38d-4985-720e-0f993a68ee41"))[0]
        # READ NOTIFY
        self.__characteristics['Temperature'] = \
        self.__peripheral.getCharacteristics(uuid=UUID("00002235-b38d-4985-720e-0f993a68ee41"))[0]
    ...
    def __setTemperatureNotification(self, byte):
        self.__peripheral.writeCharacteristic(self.__characteristics['Temperature'].valHandle + 2,
    ...
    def __setHumidityNotification(self, byte):
        self.__peripheral.writeCharacteristic(self.__characteristics['Humidity'].valHandle + 2,
                                              int(byte).to_bytes(1, byteorder='little'))
    ...
    def readLoggedDataInterval(self, startMs=None, stopMs=None):
        self.setSyncTimeMs()
        time.sleep(
            0.1)  # Sleep a bit to enable the gadget to set the SyncTime; otherwise 0 is read when readNewestTimestampMs is used
